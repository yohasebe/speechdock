...
| カテゴリ | オプション |
|----------|----------|
| **音声認識** | プロバイダ、モデル、言語、音声入力、VAD、パネル動作 |
| **音声合成** | プロバイダ、モデル、音声、速度、言語、音声出力、パネル動作 |
| **翻訳** | パネル翻訳プロバイダ/モデル、字幕翻訳プロバイダ/言語 |
| **字幕** | 位置、フォントサイズ、不透明度、最大行数、翻訳 |
| **ショートカット** | グローバルホットキーとパネルショートカット |
| **テキスト置換** | 組み込みパターンとカスタムルール |
| **外観** | フォントサイズ、パネルスタイル、ログイン時に起動 |
| **APIキー** | クラウドプロバイダのAPIキー（オプション） |
| **About** | バージョン情報、ヘルプ、アップデートの確認 |
